...
namespace GrayIris.Utilities.UI.Controls
{
	...
	public abstract class YaTabDrawerBase : Component
	{
		...
		public abstract void DrawTab( Color foreColor,
                                      ...
                                      Graphics graphics,
                                      SizeF tabSize,
#pragma warning disable CS1573 // Parameter 'isNewTab' has no matching param tag in the XML comment for 'YaTabDrawerBase.DrawTab(Color, Color, Color, Color, Color, Color, bool, bool, DockStyle, Graphics, SizeF, bool)' (but other parameters do)
                                      bool isNewTab);
#pragma warning restore CS1573 // Parameter 'isNewTab' has no matching param tag in the XML comment for 'YaTabDrawerBase.DrawTab(Color, Color, Color, Color, Color, Color, bool, bool, DockStyle, Graphics, SizeF, bool)' (but other parameters do)
