...
#pragma warning disable CS1573 // Parameter 'isNewTab' has no matching param tag in the XML comment for 'VsTabDrawer.DrawTab(Color, Color, Color, Color, Color, Color, bool, bool, DockStyle, Graphics, SizeF, bool)' (but other parameters do)
#pragma warning restore CS1574 // XML comment has cref attribute 'DrawTab(Color,Color,Color,Color,Color,bool,DockStyle,Graphics,SizeF)' that could not be resolved
        {
#pragma warning restore CS1573 // Parameter 'isNewTab' has no matching param tag in the XML comment for 'VsTabDrawer.DrawTab(Color, Color, Color, Color, Color, Color, bool, bool, DockStyle, Graphics, SizeF, bool)' (but other parameters do)
