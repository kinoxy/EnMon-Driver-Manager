...
#pragma warning disable CS0108 // 'YaTabControl.Margin' hides inherited member 'Control.Margin'. Use the new keyword if hiding was intended.
        /// <summary>
...
#pragma warning restore CS0108 // 'YaTabControl.Margin' hides inherited member 'Control.Margin'. Use the new keyword if hiding was intended.
        {
            get
            {
                return yaMargin;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member 'YaTabControl.OverIndex'
        public virtual int OverIndex { get; set; }
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'YaTabControl.OverIndex'

#pragma warning disable CS1574 // XML comment has cref attribute 'Count' that could not be resolved
        /// <summary>
...
#pragma warning restore CS1574 // XML comment has cref attribute 'Count' that could not be resolved
        {
            get
            {
...
#pragma warning disable CS0067 // The event 'YaTabControl.HoverColorChanged' is never used
        /// <summary>
        /// Occurs after the hover color has changed
        /// </summary>
        public event EventHandler HoverColorChanged;
#pragma warning restore CS0067 // The event 'YaTabControl.HoverColorChanged' is never used

#pragma warning disable CS0108 // 'YaTabControl.MarginChanged' hides inherited member 'Control.MarginChanged'. Use the new keyword if hiding was intended.
        /// <summary>
        /// Occurs after the margin for the control has changed.
        /// </summary>
        public event EventHandler MarginChanged;
#pragma warning restore CS0108 // 'YaTabControl.MarginChanged' hides inherited member 'Control.MarginChanged'. Use the new keyword if hiding was intended.
...
#pragma warning disable CS0114 // 'YaTabControl.OnMarginChanged(EventArgs)' hides inherited member 'Control.OnMarginChanged(EventArgs)'. To make the current member override that implementation, add the override keyword. Otherwise add the new keyword.
        /// <summary>
...
#pragma warning restore CS0114 // 'YaTabControl.OnMarginChanged(EventArgs)' hides inherited member 'Control.OnMarginChanged(EventArgs)'. To make the current member override that implementation, add the override keyword. Otherwise add the new keyword.
        {
...
#pragma warning disable CS1574 // XML comment has cref attribute 'OnMouseLeave(MouseEventArgs)' that could not be resolved
        /// <summary>
...
#pragma warning restore CS1574 // XML comment has cref attribute 'OnMouseLeave(MouseEventArgs)' that could not be resolved
        {
            OverIndex = -1;
            Invalidate();
        }
...
#pragma warning disable CS1572 // XML comment has a param tag for 'cea', but there is no parameter by that name
        /// <summary>
        /// Overridden. Inherited from <see cref="Control"/>.
        /// </summary>
        /// <param name="cea">
...
#pragma warning disable CS1573 // Parameter 'e' has no matching param tag in the XML comment for 'YaTabControl.OnMouseClick(MouseEventArgs)' (but other parameters do)
#pragma warning restore CS1572 // XML comment has a param tag for 'cea', but there is no parameter by that name
        {
#pragma warning restore CS1573 // Parameter 'e' has no matching param tag in the XML comment for 'YaTabControl.OnMouseClick(MouseEventArgs)' (but other parameters do)
            base.OnMouseClick(e);
        }
